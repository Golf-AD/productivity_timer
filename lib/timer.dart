  ...
  */
  ...
  Future readSettings() async {
    ...
    */
    ...
    longBreak = (prefs.getInt('longBreak') == null ? 30 : prefs.getInt('longBreak'))!;
    */
    work = (prefs.getInt('workTime') == null ? 5 : prefs.getInt('workTime'))!;
    shortBreak = (prefs.getInt('shortBreak') == null ? 1 : prefs.getInt('shortBreak'))!;
    longBreak = (prefs.getInt('longBreak') == null ? 3 : prefs.getInt('longBreak'))!;
  }
